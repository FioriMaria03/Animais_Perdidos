...
function App() {
  const [listaAnimais, setListaAnimais] = useState([
    ...
    {id: 2, descricao: "cor: Preto, Pouco pelo, Tem coleira", local: "Avenida Brasil, Bairro Centro, Cidade: Bauru", raca: "Gato - Persa", perdido:true, resgatdo:false, isConcluido: false},
    {id: 3, descricao: "cor: Branco com Manchas Marrom, peludinho, Não tem coleira", local: "Rua Luiz Biral, Bairro Núcleo, Cidade: Lençóis Paulista", raca: "Cachorro - Vira-lata",perdido:true, resgatdo:false, isConcluido: false},
  ]);
